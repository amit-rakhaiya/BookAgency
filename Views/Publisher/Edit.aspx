...
<% using (Html.BeginForm()) { %>
    ...
    <fieldset>
        ...
        <div class="editor-label">
            <%: Html.LabelFor(model => model.publisher_name) %>
        </div>
        <div class="editor-field">
            <%: Html.EditorFor(model => model.publisher_name) %>
            <%: Html.ValidationMessageFor(model => model.publisher_name) %>
        </div>
        ...
        <div class="editor-label">
            <%: Html.LabelFor(model => model.publisher_url_keyword) %>
        </div>
        <div class="editor-field">
            <%: Html.EditorFor(model => model.publisher_url_keyword) %>
            <%: Html.ValidationMessageFor(model => model.publisher_url_keyword) %>
        </div>
